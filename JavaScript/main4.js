...
- Регистр слов важен  и его нужно учитывать. 
  ...
  */
  ...
  // ---------------------------------------------------------------
  // ---------------------------------------------------------------
  /*Представим ситуацию - у тебя есть история транзакций клиента 
  банка за последний день. Нужно реализовать функционал - нахождения транзакций, 
  которые были больше определенной суммы. Разумеется задача у нас будет упрощенная, 
список транзакций - это обычный массив чисел. Функция getBigTransactions  принимает 
массив всех транзакций клиента и должна вернуть массив транзакций, 
которые были больше заданной суммы. Если таких транзакций
не найдено - возвращаем пустой массив.  */
...
/*У цьому прикладі функція filter застовується до масиву 
transactions для знаходження транзакцій, 
які перевищую вказану суму, і повертає
 новий масив із відповідними транзакція. */
//----------------------------------------------
// function getBigTransactions(transactions, amount) {
//   let bigTransactions = [];
//   for (let i = 0; i < transactions.length; i++) {
//     if (transactions[i] > amount) {
//       bigTransactions.push(transactions[i]);
//     }
//   }
//   return bigTransactions;
// }
/*У цьому випадку функція використовує 
цикл для перевірки кожної транзакції та додавання тих, 
які перевищують вказану суму, до нового масиву bigTransactions. */